...
//				System.out.println("Partner - received AE Request");			
		         ...
		         * También este es el único lugar donde el vector local de la matriz 
...
//          System.out.println("Partner - collected local Summary and Ack");
	        /**
	         * Obtiene todas las operaciones más recientes que las que tiene 
	         * el otro lado (el resumen recibido) y las envía al otro lado.
	         * 
	         */           			
...
//          System.out.println("Partner - sent operations");
	        /**
	         * Envía el resumen y la matriz ack al otro lado
	         * 
	         */           
...
//			System.out.println("Partner - sent EndTSAE");	
            /**
             * TSEA tuvo éxito => ejecuta las operaciones recopiladas 
